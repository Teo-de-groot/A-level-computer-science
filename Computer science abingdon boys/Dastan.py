def intput(a):
    ...
    while True:
        if a.isdigit() == True:
            ...
            a=input("Please enter an intiger: ")
...
class Dastan:
    ...
    def __GetSquareReference(self, Description):
        SelectedSquare = intput("Enter the square " + Description + " (row number followed by column number): ")
        return SelectedSquare

    def __UseMoveOptionOffer(self):
        ReplaceChoice = intput("Choose the move option from your queue to replace (1 to 5): ")
    ...
    def PlayGame(self):
        ...
        while not GameOver:
            ...
            while Choice < 1 or Choice > 3:
                Choice = intput("Choose move option to use from queue (1 to 3) or 9 to take the offer: ")
                if Choice == 9:
